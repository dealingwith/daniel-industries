...
I [said in January]({{site.url}}/2011/01/24/reamericana/) that I should re-post [this story]({{site.url}}/2003/08/14/ok-one-more-by-way-of-at-least-a-few-facts/). Took a while. I read a really amazing blog post today and its narrative involved the Bosnian crisis, so it inspired me to finally re-post this. I'll share that blog post tomorrow.
